...
namespace Entidades
{
    public class Paciente : Persona
    {
        ...
        public Paciente(string dni, string nombre, string apellido, string sexo, int idNacionalidad, DateTime fechaNacimiento, string direccionPaciente, int idProvincia, int idLocalidad, string tipoSangre, string correo, string telefono, bool estadoPaciente)
        : base(dni, nombre, apellido, sexo, idNacionalidad, fechaNacimiento, direccionPaciente, idProvincia, idLocalidad, correo, telefono)
        {
            _tipoSangre = tipoSangre;
