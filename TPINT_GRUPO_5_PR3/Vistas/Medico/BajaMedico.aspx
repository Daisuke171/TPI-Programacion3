...
<body>
    <form id="form1" runat="server" defaultbutton="btnBuscar">
        ...
        <main>
            ...
            <div class="campo">
                <p>Ingrese legajo:</p>
                <asp:TextBox ID="txtBoxLegajo" runat="server" ValidationGroup="2"></asp:TextBox>
                <asp:RegularExpressionValidator ID="revLegajo" runat="server" ControlToValidate="txtBoxLegajo" Font-Bold="True" Font-Size="Medium" ForeColor="Red" ValidationExpression="^[0-9,$]*$" Display="Dynamic" ValidationGroup="2">* Legajo Invalido</asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator ID="rfvLegajo" runat="server" ControlToValidate="txtBoxLegajo" Display="Dynamic" Font-Bold="True" Font-Size="Medium" ForeColor="Red" ValidationGroup="2">* Ingrese un Legajo</asp:RequiredFieldValidator>
            </div>

            <asp:Button ID="btnBuscar" runat="server" CssClass="btnEnviar" Text="Buscar" OnClick="btnBuscar_Click" ValidationGroup="2" />
            <asp:Button ID="btnMostarTodos" runat="server" CssClass="btnEnviar" Text="Motrar Todos" OnClick="btnMostarTodos_Click" />
            <asp:Label ID="lbl_confirmacion" runat="server" Font-Bold="True"></asp:Label>
            <div class="gv-container">
                <asp:GridView ID="gvMedico" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" OnRowDeleting="gvMedico_RowDeleting" AllowPaging="True" OnPageIndexChanging="gvMedico_PageIndexChanging" PageSize="5" EmptyDataText="No se encontraron coincidencias">
                    <Columns>
