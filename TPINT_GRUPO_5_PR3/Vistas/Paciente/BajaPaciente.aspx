    ...
    <form id="form1" runat="server">
        ...
        <main>
            ...
            <div class="gv-container">
                <asp:GridView ID="gvPaciente" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" OnRowDeleting="gvPaciente_RowDeleting" AllowPaging="True" OnPageIndexChanging="gvPaciente_PageIndexChanging" PageSize="5">
                    <Columns>
