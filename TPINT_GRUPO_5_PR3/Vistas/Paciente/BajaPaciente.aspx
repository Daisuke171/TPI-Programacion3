    ...
    <form id="form1" runat="server" defaultbutton="btnBuscar">
        ...
        <main>
            ...
            <div class="campo">
                ...
                <asp:RegularExpressionValidator ID="revDNI" runat="server" ControlToValidate="txtBoxDNI" Font-Bold="True" Font-Size="Large" ForeColor="Red" ValidationExpression="^[0-9,$]*$">* DNI Invalido</asp:RegularExpressionValidator>
            </div>
            ...
            <div class="gv-container">
                <asp:GridView ID="gvPaciente" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" OnRowDeleting="gvPaciente_RowDeleting" AllowPaging="True" OnPageIndexChanging="gvPaciente_PageIndexChanging" PageSize="5" EmptyDataText="No se encontraron coincidencias">
                    <Columns>
